                    ...
                    <div className="w-full max-w-md animate-fade-in">
                            ...
                            <div className="flex items-start gap-3 rounded-lg border border-destructive/30 bg-destructive/5 p-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-destructive/80 font-body mt-0.5">
                                        {errors.email || errors.password || 'Invalid email or password. Please check your credentials and try again.'}
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full h-12 rounded-lg bg-primary text-primary-foreground font-body font-semibold text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-all active:scale-[0.98] shadow-card disabled:opacity-50"
                            >
                        ...
                        <div className="mt-6">
                            <button className="w-full h-12 rounded-lg border border-input bg-card text-foreground font-body text-sm font-medium flex items-center justify-center gap-2 hover:bg-secondary transition-colors">

                        <div className="mt-6 grid grid-cols-2 gap-3">
                            <a
                                href={route('auth.google')}
                                className="h-12 rounded-lg border border-input bg-card text-foreground font-body text-sm font-medium flex items-center justify-center gap-2 hover:bg-secondary transition-colors"
                            >
                            ...
                            <button className="h-12 rounded-lg border border-input bg-card text-foreground font-body text-sm font-medium flex items-center justify-center gap-2 hover:bg-secondary transition-colors">
