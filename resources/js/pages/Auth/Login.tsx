                    ...
                    <div className="w-full max-w-md animate-fade-in">
                        ...
                        <div className="mt-6 flex justify-center">
                           <a
                               ...
                               className="w-[260px] h-12 rounded-lg border border-input bg-card text-foreground font-body text-sm font-medium flex items-center justify-center gap-2 hover:bg-secondary transition-colors"
                    >
